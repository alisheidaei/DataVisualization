...
##### CA #####
PltData <- data.frame(var1 = MXGBoostData$ca_obs,
                      var2 = MXGBoostData$ca_pred,
                      fill = 1) %>%
...
Plt1 <- ggarrange(xplot, NULL, sp, yplot, labels = c("","",""), 
                  ...
                  common.legend = F)
ggsave(plot = Plt1, "Observed vs predicted CA MXGBoost.pdf", width = 10, height = 10)




##### EC ##### 
PltData <- data.frame(var1 = MXGBoostData$ec_obs,
                      var2 = MXGBoostData$ec_pred,
                      fill = 1) %>%
  filter(var1 < max(var1))
...
Plt1 <- ggarrange(xplot, NULL, sp, yplot, labels = c("","",""), 
                  ...
                  widths = c(2, 1), heights = c(1, 2),
                  common.legend = F)
ggsave(plot = Plt1, "Observed vs predicted EC MXGBoost.pdf", width = 10, height = 10)



##### SI ##### 
PltData <- data.frame(var1 = MXGBoostData$si_obs,
                      var2 = MXGBoostData$si_pred,
                      fill = 1) %>%
  filter(var1 < max(var1))
...
Plt1 <- ggarrange(xplot, NULL, sp, yplot, labels = c("","",""), 
                  ...
                  widths = c(2, 1), heights = c(1, 2),
                  common.legend = F)
ggsave(plot = Plt1, "Observed vs predicted SI MXGBoost.pdf", width = 10, height = 10)
...
#####  SO4 ##### 
PltData <- data.frame(var1 = MXGBoostData$so4_obs,
                      var2 = MXGBoostData$so4_pred,
                      fill = 1) %>%
  filter(var1 < max(var1))
...
Plt1 <- ggarrange(xplot, NULL, sp, yplot, labels = c("","",""), 
                  ...
                  widths = c(2, 1), heights = c(1, 2),
                  common.legend = F)
ggsave(plot = Plt1, "Observed vs predicted SO4 MXGBoost.pdf", width = 10, height = 10)
